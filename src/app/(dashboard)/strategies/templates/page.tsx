...
import { strategyTemplates } from '@/lib/data/strategies';
import { ArrowRight, Star } from 'lucide-react';

export const metadata: Metadata = {
    title: 'Strategy Templates — ShefaFx',
    description: 'Browse pre-built strategy templates and get started quickly.',
};
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-2 flex-wrap">
                {['All', 'Beginner', 'Intermediate', 'Advanced'].map((t, i) => (
                    <button
                        key={t}
                        className={`px-3 py-1.5 text-xs font-medium rounded-lg border transition-all ${i === 0

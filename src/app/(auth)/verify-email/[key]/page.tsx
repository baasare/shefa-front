            ...
            <AuthCard
                ...
                subtitle={
                    status === 'loading' ? 'Please wait while we activate your account...' :
                        status === 'success' ? 'Your account has been successfully activated. You are being redirected to welcome page...' :
                ...
                <div className="flex flex-col items-center justify-center py-8 space-y-6">
                    ...
                    {status === 'success' && (
                        <div className="flex flex-col items-center space-y-6">
                            ...
                            <Link href={routes.onboarding.welcome} className="w-full">
